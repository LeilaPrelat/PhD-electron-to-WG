...
print('1-Extra: Plot the EELS without integration as a function of kx, energy = %i eV, ze = %i nm' %(energy_0,ze_0*1e3))
...
print('2-Fig. 1b-c) Plot the EELS without integration as a function of (k_paralllel, energy), ze = %i nm, beta = %.2f'%(ze_0*1e3,beta))
...
if zoom == 0:
    if d_microns == 0.2:
        ...
        plt.xticks(np.arange(10,90,10))
if zoom == 0:
      plt.text(40, 6.5,r"$k_\parallel = \omega/v$",color = 'green', rotation=47,fontsize = tamletra)
...
print('3-Fig. 1e) Plot the EELS integrated over kx as function of energy for a fixed ze')
...
print('4-Extra (Color map): Plot the EELS integrated over kx as function of (energy,ze)')
