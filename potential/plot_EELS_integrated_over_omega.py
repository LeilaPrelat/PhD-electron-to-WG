...
def Pintegrated_over_z_vs_theta(V0,theta_mrad):
    ...
    np.savetxt('list_energy_of_P' + label_Ee + '_dd%i_hh%.2f_V0%.2feV_theta%.2fmrad_bmin%.2f.txt' %(dd,bb,V0,theta_mrad,bmin_vals0), list_energy, fmt='%.10f', delimiter='\t', header = header, encoding=None)
