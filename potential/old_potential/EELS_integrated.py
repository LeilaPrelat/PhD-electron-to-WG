...
def EELS_from_BEM_interpolated(energy_eV,a,h,xe,Eelectron_keV,N):
    """
    Parameters
    ----------
    ...
    name2 = 'EELS_along_z_Si_N%i_a%inm_h%inm_ze%inm_Ee%ikeV%s_energy_%.8f'%(N,a,h,ze,Eelectron_keV,labelxe,energy_eV) + '.txt'
    ...
    listz_norm_a_BEM = np.array(listz_correct)/a   ## we interpolate using z/W, same axis as the potential code
    ...
    EELS_interp =  interp1d(listz_norm_a_BEM, listEELS_correct)
...
def P_integrand_over_z(value_z_norm_a, theta, V0, xe, Eelectron_keV, bb, dd, energy_eV, a, N, list_z_norm_a, listV_normV0):
    """
    Parameters
    ----------
    ...
    listz_norm_a_BEM, EELS_interp = EELS_from_BEM_interpolated(energy_eV,a,h,xe,Eelectron_keV,N)
...
def P_integrated_over_z(z_min_val, theta, V0, xe, Eelectron_keV, bb, dd, energy_eV, a, N , list_z_norm_a, listV_normV0):
    """
    Parameters
    ----------
    ...
    EELS_array = P_integrand_over_z(listz_norm_a_BEM_interp, theta, V0, xe, Eelectron_keV, bb, dd, energy_eV, a, N, list_z_norm_a, listV_normV0 )
    ...
    return list_P*delta_z_norm_a,listz_norm_a_BEM_interp,EELS_array
